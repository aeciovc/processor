...
public class SenderTest {
    ...
    public void testSendMessage(){
        ...
        //Action
        sender.sendMessage("test", messageToSend); //

        //Expected Result
        String expectedResult = messageToSend;

        //Assert
        assertThat(this.jmsTemplateQueue.receiveAndConvert("test")).isEqualTo(expectedResult);
    }
